...
export EC_VERSION APP_VERSION APP_CHANNEL APP_CHANNEL_ID APP_CHANNEL_SLUG RELEASE_YAML_DIR EC_BINARY UPLOAD_BINARIES ARCH USE_CHAINGUARD USES_DEV_BUCKET
