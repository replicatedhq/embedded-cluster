...
// const HostsDetail: React.FC<HostsDetailProps> = ({ onComplete, stepStatus }) => {
//   const [isPreflightsPolling, setIsPreflightsPolling] = useState(false);
//   const [isInstallationStatusPolling, setIsInstallationStatusPolling] = useState(
...
//     },
//     enabled: isInstallationStatusPolling && stepStatus !== 'completed' && stepStatus !== 'failed',
...
//       return response.json() as Promise<PreflightResponse>;
//     },
//     enabled: isPreflightsPolling && stepStatus !== 'completed' && stepStatus !== 'failed',
//     refetchInterval: 1000,
//   });
...
//   // Disable polling if step status is completed or failed
//   useEffect(() => {
...
//   // If the step is already completed, show success state
//   if (stepStatus === 'completed') {
//     return (
//       <div className="flex flex-col items-center justify-center py-12">
//         <CheckCircle className="w-12 h-12 text-green-500 mb-4" />
//         <p className="text-lg font-medium text-gray-900">Host Setup Complete</p>
//         <p className="text-sm text-gray-500 mt-2">All host requirements have been validated successfully.</p>
//       </div>
//     );
//   }

//   // If the step failed, show failure state
//   if (stepStatus === 'failed') {
//     return (
//       <div className="flex flex-col items-center justify-center py-12">
//         <XCircle className="w-12 h-12 text-red-500 mb-4" />
//         <p className="text-lg font-medium text-gray-900">Host Setup Failed</p>
//         <p className="text-sm text-gray-500 mt-2">Some host requirements could not be validated.</p>
//       </div>
//     );
//   }
...
const HostsDetail: React.FC<HostsDetailProps> = ({ onComplete }) => {
  const [isPreflightsPolling, setIsPreflightsPolling] = useState(false);
