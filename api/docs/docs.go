    ...
    "components": {
        "schemas": {
            ...
            "types.KURLMigrationPhase": {
                ...
                "type": "string",
                "x-enum-varnames": [
                    "KURLMigrationPhaseDiscovery",
                    "KURLMigrationPhasePreparation",
                    "KURLMigrationPhaseECInstall",
                    "KURLMigrationPhaseDataTransfer",
                    "KURLMigrationPhaseCompleted"
                ]
            },
            "types.KURLMigrationState": {
                ...
                "x-enum-varnames": [
                    ...
                    "KURLMigrationStateInProgress",
                    "KURLMigrationStateCompleted",
                    "KURLMigrationStateFailed"
                ]
            },
            "types.KURLMigrationStatusResponse": {
                ...
                "properties": {
                    ...
                    "phase": {
                        "$ref": "#/components/schemas/types.KURLMigrationPhase"
                    },
                    "progress": {
                    ...
                    "state": {
                        "$ref": "#/components/schemas/types.KURLMigrationState"
                    }
                },
                "required": [
                    "message",
            ...
            "types.StartKURLMigrationRequest": {
                ...
                "properties": {
                    ...
                    "transferMode": {
                        "$ref": "#/components/schemas/types.TransferMode"
                    }
                },
                "required": [
                    "transferMode"
    ...
    "paths": {
        ...
        "/linux/kurl-migration/config": {
            "get": {
                ...
                "operationId": "getKURLMigrationInstallationConfig",
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/types.StartKURLMigrationResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/linux/kurl-migration/status": {
            "get": {
                ...
                "operationId": "getKURLMigrationStatus",
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/types.KURLMigrationStatusResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/linux/upgrade/host-preflights/run": {
            "post": {
                ...
                "operationId": "postLinuxUpgradeRunHostPreflights",
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/types.HostPreflights"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/linux/upgrade/host-preflights/status": {
            "get": {
                ...
                "operationId": "getLinuxUpgradeHostPreflightsStatus",
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
