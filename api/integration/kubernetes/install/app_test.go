			...
			Groups: []kotsv1beta1.ConfigGroup{
				{
					...
					Items: []kotsv1beta1.ConfigItem{
						...
						},
						{
							...
							Value:   multitype.BoolOrString{StrVal: "mysql"},
						},
						{
							Name:    "db_host",
							Type:    "text",
							...
							Value:   multitype.BoolOrString{StrVal: "{{repl ConfigOption \"db_type\" }}.example.com"},
						...
						},
						{
							...
							Type:    "text",
							Title:   "Database Port",
							Default: multitype.BoolOrString{StrVal: "{{repl if ConfigOptionEquals \"db_type\" \"mysql\" }}3306{{repl else }}5432{{repl end }}"},
							Value:   multitype.BoolOrString{StrVal: "{{repl if ConfigOptionEquals \"db_type\" \"mysql\" }}3306{{repl else }}5432{{repl end }}"},
							When:    "{{repl ConfigOptionEquals \"db_enabled\" \"true\" }}",
						},
					},
				},
					...
					Items: []kotsv1beta1.ConfigItem{
						{
							...
							Value:   multitype.BoolOrString{StrVal: "false"},
						},
					},
				},
			},
