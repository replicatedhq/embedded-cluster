	...
	tests := []struct {
		...
		},
		{
			...
			want: &ecv1beta1.ProxySpec{
				...
				NoProxy:    "localhost,127.0.0.1,.default,.local,.svc,kubernetes,kotsadm-rqlite,no-proxy-1,no-proxy-2,1.1.1.1/22,2.2.2.2/22",
			},
		},
		{
			...
			want: &ecv1beta1.ProxySpec{
				...
				NoProxy:    "localhost,127.0.0.1,.default,.local,.svc,kubernetes,kotsadm-rqlite,other-no-proxy-1,other-no-proxy-2,1.1.1.1/22,2.2.2.2/22",
			},
		},
		{
			name: "no cluster config should not set proxy",
			init: func(t *testing.T, flagSet *flag.FlagSet) {
				t.Setenv("HTTP_PROXY", "http://proxy")
				t.Setenv("HTTPS_PROXY", "https://proxy")
				t.Setenv("NO_PROXY", "no-proxy-1,no-proxy-2")
			...
			want: &ecv1beta1.ProxySpec{
				HTTPProxy:  "http://proxy",
				HTTPSProxy: "https://proxy",
				NoProxy:    "localhost,127.0.0.1,.default,.local,.svc,kubernetes,kotsadm-rqlite,no-proxy-1,no-proxy-2",
			},
		},
		{
			...
			want: &ecv1beta1.ProxySpec{
				HTTPProxy:  "http://other-proxy",
				HTTPSProxy: "https://other-proxy",
				NoProxy:    "localhost,127.0.0.1,.default,.local,.svc,kubernetes,kotsadm-rqlite,no-proxy-1,no-proxy-2,other-no-proxy-1,other-no-proxy-2,1.1.1.1/22,2.2.2.2/22",
			},
		},
	}
