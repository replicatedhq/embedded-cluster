...
func (r *InstallReporter) ReportPreflightsFailed(ctx context.Context, output *apitypes.HostPreflightOutput) {
	r.reporter.ReportPreflightsFailed(ctx, output)
}

func (r *InstallReporter) ReportPreflightsBypassed(ctx context.Context, output *apitypes.HostPreflightOutput) {
...
func (r *JoinReporter) ReportPreflightsFailed(ctx context.Context, output *apitypes.HostPreflightOutput) {
	r.reporter.ReportPreflightsFailed(ctx, output)
}

func (r *JoinReporter) ReportPreflightsBypassed(ctx context.Context, output *apitypes.HostPreflightOutput) {
	r.reporter.ReportPreflightsBypassed(ctx, output)
}
