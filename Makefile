...
.PHONY: cmd/installer/cli/goods/bins/k0s
cmd/installer/cli/goods/bins/k0s:
	$(MAKE) output/bins/k0s-$(K0S_VERSION)-$(ARCH)
	mkdir -p cmd/installer/cli/goods/bins
...
.PHONY: cmd/installer/cli/goods/bins/kubectl-support_bundle
cmd/installer/cli/goods/bins/kubectl-support_bundle:
...
.PHONY: cmd/installer/cli/goods/bins/kubectl-preflight
cmd/installer/cli/goods/bins/kubectl-preflight:
...
.PHONY: cmd/installer/cli/goods/bins/local-artifact-mirror
cmd/installer/cli/goods/bins/local-artifact-mirror:
	mkdir -p cmd/installer/cli/goods/bins
...
.PHONY: cmd/installer/cli/goods/bins/fio
cmd/installer/cli/goods/bins/fio:
...
.PHONY: cmd/installer/cli/goods/bins/manager
cmd/installer/cli/goods/bins/manager:
	mkdir -p cmd/installer/cli/goods/bins
...
.PHONY: cmd/installer/cli/goods/internal/bins/kubectl-kots
cmd/installer/cli/goods/internal/bins/kubectl-kots:
	mkdir -p cmd/installer/cli/goods/internal/bins
...
.PHONY: static
static: cmd/installer/cli/goods/bins/k0s \
	cmd/installer/cli/goods/bins/kubectl-preflight \
	cmd/installer/cli/goods/bins/kubectl-support_bundle \
	cmd/installer/cli/goods/bins/local-artifact-mirror \
	cmd/installer/cli/goods/bins/fio \
...
.PHONY: static-dryrun
static-dryrun:
	@mkdir -p cmd/installer/cli/goods/bins cmd/installer/cli/goods/internal/bins
	@touch cmd/installer/cli/goods/bins/k0s \
		cmd/installer/cli/goods/bins/kubectl-preflight \
		cmd/installer/cli/goods/bins/kubectl-support_bundle \
		cmd/installer/cli/goods/bins/local-artifact-mirror \
		cmd/installer/cli/goods/bins/fio \
...
unit-tests: envtest
	mkdir -p cmd/installer/cli/goods/bins cmd/installer/cli/goods/internal/bins
	touch cmd/installer/cli/goods/bins/BUILD cmd/installer/cli/goods/internal/bins/BUILD # compilation will fail if no files are present
...
clean:
	rm -rf output
	rm -rf cmd/installer/cli/goods/bins/*
	rm -rf cmd/installer/cli/goods/internal/bins/*
	rm -rf build
	rm -rf bin
...
.PHONY: test-lam-e2e
test-lam-e2e: cmd/installer/cli/goods/bins/local-artifact-mirror
