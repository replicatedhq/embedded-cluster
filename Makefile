...
ADMIN_CONSOLE_CHART_URL = oci://ttl.sh/sgalsaleh
ADMIN_CONSOLE_CHART_NAME = admin-console
ADMIN_CONSOLE_CHART_VERSION = 1.0.2-sgalsaleh
ADMIN_CONSOLE_IMAGE_OVERRIDE = ttl.sh/sgalsaleh/kotsadm:v1.0.2-sgalsaleh
...
KOTS_BINARY_URL_OVERRIDE = https://9368-2607-fb91-881f-b0d-99a2-3000-3e6b-da92.ngrok-free.app/kots_linux_amd64.tar.gz
