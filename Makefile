...
K0S_VERSION = v1.30.5+k0s.0-ec.0
...
ifeq ($(K0S_VERSION),v1.30.5+k0s.0-ec.0)
K0S_BINARY_SOURCE_OVERRIDE = https://tf-staging-embedded-cluster-bin.s3.amazonaws.com/custom-k0s-binaries/k0s-v1.30.5%2Bk0s.0-ec.0-$(ARCH)
