...
K0S_VERSION_CURRENT = v1.31.11+k0s.0
K0S_GO_VERSION_CURRENT = v1.31.11+k0s.0
PREVIOUS_K0S_VERSION_CURRENT = v1.30.14+k0s.0

K0S_VERSION_1_30 = v1.30.14+k0s.0
K0S_GO_VERSION_1_30 = v1.30.14+k0s.0
PREVIOUS_K0S_VERSION_1_30 = v1.29.15+k0s.0

K0S_VERSION_1_29 = v1.29.15+k0s.0
K0S_GO_VERSION_1_29 = v1.29.15+k0s.0
PREVIOUS_K0S_VERSION_1_29 = v1.28.14+k0s.0-ec.0

K0S_VERSION=$(K0S_VERSION_CURRENT)
K0S_GO_VERSION=$(K0S_GO_VERSION_CURRENT)
PREVIOUS_K0S_VERSION=$(PREVIOUS_K0S_VERSION_CURRENT)
...
ifeq ($(K0S_VERSION),v1.28.14+k0s.0-ec.0)
