...
K0S_VERSION = v1.30.4+al.0
K0S_GO_VERSION = release-1.30
PREVIOUS_K0S_VERSION ?= v1.28.10+k0s.0
K0S_BINARY_SOURCE_OVERRIDE = https://dev-embedded-cluster-bin.s3.amazonaws.com/k0s-binaries/k0s-v1-30-4-al-0-arm64
