...
EMBEDDED_OPERATOR_CHART_VERSION = 0.0.0-alpha.7
EMBEDDED_OPERATOR_BINARY_URL_OVERRIDE = https://repldev-ethan-test.s3.amazonaws.com/manager-$(EMBEDDED_OPERATOR_CHART_VERSION)
