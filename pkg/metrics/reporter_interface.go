...
type ReporterInterface interface {
	...
	ReportPreflightsFailed(ctx context.Context, output *apitypes.HostPreflightOutput)

	// ReportPreflightsBypassed reports that the preflights failed but were bypassed
	ReportPreflightsBypassed(ctx context.Context, output *apitypes.HostPreflightOutput)
