...
func WriteK0sConfig(ctx context.Context, networkInterface string, airgapBundle string, podCIDR string, serviceCIDR string, overrides string, mutate func(*k0sconfig.ClusterConfig) error) (*k0sconfig.ClusterConfig, error) {
