...
func WriteK0sConfig(ctx context.Context, installConfig models.InstallationConfig, airgapBundle string, mutate func(*k0sv1beta1.ClusterConfig) error) (*k0sv1beta1.ClusterConfig, error) {
	...
	address, err := netutils.FirstValidAddress(installConfig.NetworkInterface)
	if err != nil {
	...
	cfg.Spec.Network.PodCIDR = installConfig.PodCIDR
	cfg.Spec.Network.ServiceCIDR = installConfig.ServiceCIDR
