...
type Interface interface {
	...
	DeleteZone(ctx context.Context, zone string, opts ...Option) error
	...
	RemovePortFromZone(ctx context.Context, port string, opts ...Option) error
...
// DeleteZone deletes a zone.
func DeleteZone(ctx context.Context, zone string, opts ...Option) error {
	return _f.DeleteZone(ctx, zone, opts...)
}
...
// RemovePortFromZone removes a port from a zone.
func RemovePortFromZone(ctx context.Context, port string, opts ...Option) error {
	return _f.RemovePortFromZone(ctx, port, opts...)
}
