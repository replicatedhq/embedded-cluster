...
func (s *SeaweedFS) Upgrade(ctx context.Context, logf types.LogFunc, kcli client.Client, hcli helm.Client, overrides []string) error {
	...
	if !exists {
		...
		return s.Install(ctx, logf, kcli, hcli, overrides, nil)
	}
