...
func (v *Velero) Upgrade(ctx context.Context, logf types.LogFunc, kcli client.Client, hcli helm.Client, overrides []string) error {
	...
	if !exists {
		...
		if err := v.Install(ctx, logf, kcli, hcli, overrides, nil); err != nil {
