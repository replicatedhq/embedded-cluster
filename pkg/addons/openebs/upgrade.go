...
func (o *OpenEBS) Upgrade(ctx context.Context, logf types.LogFunc, kcli client.Client, hcli helm.Client, overrides []string) error {
	...
	if !exists {
		...
		if err := o.Install(ctx, logf, kcli, hcli, overrides, nil); err != nil {
