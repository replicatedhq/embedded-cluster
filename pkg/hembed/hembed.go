...
// a mark to the end of the file. The mark is on the format EMBEDDEDCLUSTERCHARTS0000000000 where
...
// EMBEDDEDCLUSTERCHARTS0000000000 where the number is the length of the embedded data.
