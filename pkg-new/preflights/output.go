...
func (p *Preflights) PrintTable(o *apitypes.HostPreflightsOutput) {
	printTable(o)
}

// PrintTableWithoutInfo prints the preflight output in a table format without info results.
func (p *Preflights) PrintTableWithoutInfo(o *apitypes.HostPreflightsOutput) {
...
func (p *Preflights) SaveToDisk(o *apitypes.HostPreflightsOutput, path string) error {
...
func (p *Preflights) OutputFromReader(from io.Reader) (*apitypes.HostPreflightsOutput, error) {
