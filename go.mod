...
require (
	...
	github.com/k0sproject/k0s v1.30.1-0.20240610130530-8003cbd6e399
	github.com/replicatedhq/embedded-cluster-kinds v1.3.5
	github.com/replicatedhq/embedded-cluster-operator v0.35.0
...
require (
	...
	github.com/mesosphere/toml-merge v0.2.0 // indirect
